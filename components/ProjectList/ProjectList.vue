<template>
  <div>
    <section class="pt-8 px-4">
      <h1 class="text-3xl mt-2 mb-6 leading-tight font-bold">
        Desa Hatu Kabupaten Maluku Tengah
      </h1>
    ...
    <section class="pt-8 px-4">
      <h1 class="text-3xl mt-2 mb-6 leading-tight font-bold">Desa Ureng</h1>
      <div class="flex flex-wrap -mx-4">
        <div class="md:w-1/3 px-4 mb-8">
          <img
            class="rounded shadow-md"
    ...
    <section class="pt-8 px-4">
      <h1 class="text-3xl mt-2 mb-6 leading-tight font-bold">Kabupaten Buol</h1>
      <div class="flex flex-wrap -mx-4">
        <div class="md:w-1/3 px-4 mb-8">
          <img
            class="rounded shadow-md"
    ...
    <section class="pt-8 px-4">
      <h1 class="text-3xl mt-2 mb-6 leading-tight font-bold">Kabupaten Buru</h1>
      <div class="flex flex-wrap -mx-4">
        <div class="md:w-1/3 px-4 mb-8">
          <img
            class="rounded shadow-md"
