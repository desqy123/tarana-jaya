<template>
  <section class="py-8 px-4 text-center">
    <!-- <div class="max-w-2xl mx-auto">
      <h2 class="text-5xl text-center mb-3 font-bold">Testimoni</h2>
      <div class="flex items-center justify-center h-20 w-20 p-2 mx-auto mb-8 border rounded-full"><img
          class="rounded-full" src="placeholders/logos/realweb.svg" alt=""></div>
      <p class="text-xl mb-8">Michael, the Manager? I swear, that man can really close deals with people. Such a nice
        contact, great quality products, professional service. And God knows, that company is fun at parties.</p>
      <p class="text-sm font-semibold">Christian Lackawanna</p>
      <p class="text-sm">CEO at Realweb</p>
    </div> -->
    ...
    >
      <div
        class="relative w-full py-2 md:py-24 bg-indigo-700 md:w-1/2 flex flex-col item-center justify-center"
      >
        <div
        ...
        <div
          class="relative text-2xl md:text-5xl py-2 px-6 md:py-6 md:px-1 md:w-64 md:mx-auto text-indigo-100 font-bold leading-tight tracking-tight mb-0 z-20"
        >
        ...
        <div class="flex flex-col h-full relative">
          ...
          <div class="h-full relative z-10">
            <div v-show="testimonialActive === 1">
              <p
                v-show="testimonialActive == 1"
                class="text-gray-600 serif font-normal italic px-6 py-6 md:px-16 md:py-10 text-xl md:text-2xl"
              >
          ...
          <div class="flex my-4 justify-center items-center">
            ...
            <button
              class="text-center font-bold shadow-xs focus:outline-none focus:shadow-outline h-16 w-16 inline-block rounded-full mx-2"
              :class="{
                'h-12 w-12 opacity-25 bg-indigo-300 text-gray-600':
                  testimonialActive != 2,
                'h-16 w-16 opacity-100 bg-indigo-600 text-white':
            ...
            <button
              class="text-center font-bold shadow-xs focus:outline-none focus:shadow-outline h-12 w-12 inline-block rounded-full mx-2"
              :class="{
                'h-12 w-12 opacity-25 bg-indigo-300 text-gray-600':
                  testimonialActive !== 3,
                'h-16 w-16 opacity-100 bg-indigo-600 text-white':
          ...
          <div class="flex justify-center px-6 pt-2 pb-6 md:py-6">
            <div v-show="testimonialActive == 1" class="text-center">
              <h2
            ...
            <div v-show="testimonialActive == 2" class="text-center">
              <h2
                class="text-sm md:text-base font-bold text-gray-700 leading-tight"
              >
                Winter Doe
            ...
            <div v-show="testimonialActive == 3" class="text-center">
              <h2
                class="text-sm md:text-base font-bold text-gray-700 leading-tight"
              >
                John Wick
